...
function upload(selector) {
  ...
  function changehandler(_x) {
    return _changehandler.apply(this, arguments);
  }

  function _changehandler() {
    _changehandler = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
      var fileList;
  ...
  preview.addEventListener('click', function (e) {
    ...
    var block = preview.querySelector(".remove[data-name=\"".concat(name, "\"]")).parentElement;
  ...
  function golaod() {
    ...
    var previews = document.querySelectorAll('.info');
...
},{"@firebase/storage":"node_modules/@firebase/storage/dist/index.esm2017.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
(0, _upload.upload)('#file', {
  ...
  onUpload: function onUpload(files, previews) {
    files.forEach(function (file, index) {
      ...
      uploadTask.on('state_changed', function (snapshot) {
        var sendbites = snapshot.bytesTransferred / snapshot.totalBytes * 100;
        var statusdiv = previews[index].querySelector('.progres');
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                url = _context.sent;
                previews[index].parentElement.innerHTML += "\n                    <a class=\"url\" href=\"".concat(url, "\" target=\"_blank\">\u0441\u0441\u044B\u043B\u043A\u0430</a>\n                    ");
